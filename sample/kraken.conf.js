...
// Normal trade
c.buy_pct = 99 // ซื้อด้วยเงินจำนวน กี่เปอร์เซ็น
c.sell_pct = 99 // ขายด้วยเงินจำนวน กี่เปอร์เซ็น
...
c.profit_stop_pct=10 // ขายเมื่อกำไร ลดลงต่ำกว่า กี่เปอร์เซ็น เช่น ได้ กำไร 29 แต่กำไรลดลงเรื่อยๆจนถึง 20 จึงขาย
...
c.oversold_rsi = 40 // ซื้อเมื่อค่า RSI น้อยกว่าหรือเท่ากับ
